...
public class Pivot extends RealmObject {
    ...
    public double getAmountSinBonus() {
        return amountSinBonus;
    }

    public void setAmountSinBonus(double amountSinBonus) {
        this.amountSinBonus = amountSinBonus;
    }
