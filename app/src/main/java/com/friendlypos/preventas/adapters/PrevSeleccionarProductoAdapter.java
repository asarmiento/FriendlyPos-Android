...
public class PrevSeleccionarProductoAdapter extends RecyclerView.Adapter<DistrSeleccionarProductosAdapter.CharacterViewHolder> {

    private Context context;
    public List<Inventario> productosList;
    private PreventaActivity activity;
    private PrevSeleccionarProductoAdapter fragment;
    ...
    public PrevSeleccionarProductoAdapter(PreventaActivity activity, PrevSeleccionarProductoAdapter fragment, List<Inventario> productosList) {
...
*/
        ...
        holder.txt_prev_producto_factura_nombre.setText(description);

        holder.txt_prev_producto_factura_nombre.setText(description);
        holder.txt_prev_producto_factura_marca.setText("Marca: " + marca2);
        holder.txt_prev_producto_factura_tipo.setText("Tipo: " + tipoProducto);
        holder.txt_prev_producto_factura_precio.setText(precio);
        holder.txt_prev_producto_factura_disponible.setText("Disp: " + inventario.getAmount());
    ...
    public class CharacterViewHolder extends RecyclerView.ViewHolder {
        ...
        private TextView txt_prev_producto_factura_nombre, txt_prev_producto_factura_marca, txt_prev_producto_factura_tipo, txt_prev_producto_factura_precio, txt_prev_producto_factura_disponible, txt_prev_producto_factura_seleccionado;
        protected CardView cardView;

        public CharacterViewHolder(View view) {
            super(view);
            cardView = (CardView) view.findViewById(R.id.cardViewSeleccionarProductos);
            txt_prev_producto_factura_nombre = (TextView) view.findViewById(R.id.txt_prev_producto_factura_nombre);
            txt_prev_producto_factura_marca = (TextView) view.findViewById(R.id.txt_prev_producto_factura_marca);
            txt_prev_producto_factura_tipo = (TextView) view.findViewById(R.id.txt_prev_producto_factura_tipo);
            txt_prev_producto_factura_precio = (TextView) view.findViewById(R.id.txt_prev_producto_factura_precio);
            txt_prev_producto_factura_disponible = (TextView) view.findViewById(R.id.txt_prev_producto_factura_disponible);
            txt_prev_producto_factura_seleccionado = (TextView) view.findViewById(R.id.txt_prev_producto_factura_seleccionado);
        }
