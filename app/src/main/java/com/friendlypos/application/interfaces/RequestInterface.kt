...
import com.friendlypos.principal.response.BonusesResponse
import com.friendlypos.principal.response.ClientesResponse
import com.friendlypos.principal.response.ConsecutivosNumberFeResponse
import com.friendlypos.principal.response.EmailResponse
import com.friendlypos.principal.response.FacturasResponse
import com.friendlypos.principal.response.InventarioResponse
import com.friendlypos.principal.response.MarcasResponse
import com.friendlypos.principal.response.MetodoPagoResponse
import com.friendlypos.principal.response.NumeracionResponse
import com.friendlypos.principal.response.ProductosResponse
import com.friendlypos.principal.response.RecibosResponse
import com.friendlypos.principal.response.SendEmailResponse
import com.friendlypos.principal.response.SysconfResponse
import com.friendlypos.principal.response.TipoProductoResponse
import com.friendlypos.principal.response.UserResponse
import com.friendlypos.principal.response.UsuariosResponse
import com.friendlypos.principal.modelo.customer_location
import com.friendlypos.principal.modelo.customer_new
import com.friendlypos.principal.modelo.email_Id
import com.friendlypos.principal.modelo.receipts
import com.friendlypos.principal.modelo.send_email_id
import com.friendlypos.principal.modelo.visit
import com.friendlypos.principal.helpers.EnviarClienteGPS
import com.friendlypos.principal.helpers.EnviarClienteNuevo
import com.friendlypos.principal.helpers.EnviarClienteVisitado
import com.friendlypos.principal.helpers.EnviarFactura
import com.friendlypos.principal.helpers.EnviarProductoDevuelto
import com.friendlypos.principal.helpers.EnviarRecibos
